	...
	<body>
		...
		<div id="top_bar">
                <div class="login_box">
                    ...
                    <img id="imgLogin" src="http://www.comedysoftware.com/black/images/greenbutton-in2.png" alt="Log-in" />
		    <!--<span id="tempButton">Temp Button</span><br>
		    <span id="tempButton">Temp Button 2</span>	-->
			
		    <img style="position: absolute;" id="imgLogout" src="http://www.comedysoftware.com/black/images/greenbutton-out2.png" alt="Log-out" />
		...
		<div class="panelsContainer"> </div>
            ...
            <!--SIDEBAR ELEMENTS-->
                ...
                <div id="sidebar">
			<img id="top_sidebar" src="http://www.comedysoftware.com/black/images/sidebar_top_opaque.png" />
		...
		<!--DEVICES, OPTIONs PANEL-->
		   ...
		   <div id="sidebarViewContainer"></div>
			...
			<img id="bot_sidebar" src="http://www.comedysoftware.com/black/images/sidebar_bot_opaque.png" />
		</div>
